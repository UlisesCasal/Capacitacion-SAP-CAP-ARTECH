...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("LibrosListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheLibrosListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheLibrosListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheLibrosListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheLibrosListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheLibrosListGenerated.onTable().iPressRow(0);
            Then.onTheLibrosObjectPageGenerated.iSeeThisPage();
